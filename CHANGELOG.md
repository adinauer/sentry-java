...
- Bump Native SDK from v0.6.7 to v0.7.5 ([#3133](https://github.com/getsentry/sentry-java/pull/3133), [#6](https://github.com/adinauer/sentry-java/pull/6))
  - [changelog](https://github.com/getsentry/sentry-native/blob/master/CHANGELOG.md#075)
  - [diff](https://github.com/getsentry/sentry-native/compare/0.6.7...0.7.5)
